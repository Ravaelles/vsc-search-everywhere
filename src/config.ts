...
const defaultSection = "searchAnywhere";
const keys = {
  ...
  contentSearchEnabled: {
    name: "contentSearch.enabled",
    value: true,
  },
  contentSearchExclude: {
    name: "contentSearch.exclude",
    value: [] as string[],
  },
  contentSearchMaxResults: {
    name: "contentSearch.maxResults",
    value: 50,
  },
  contentSearchMaxFileSizeKb: {
    name: "contentSearch.maxFileSizeKb",
    value: 512,
  },
};
...
export function fetchContentSearchEnabled(): boolean {
  return get(
    keys.contentSearchEnabled.name,
    keys.contentSearchEnabled.value
  );
}

export function fetchContentSearchExclude(): string[] {
  return get(keys.contentSearchExclude.name, keys.contentSearchExclude.value);
}

export function fetchContentSearchMaxResults(): number {
  return get(keys.contentSearchMaxResults.name, keys.contentSearchMaxResults.value);
}

export function fetchContentSearchMaxFileSizeKb(): number {
  return get(keys.contentSearchMaxFileSizeKb.name, keys.contentSearchMaxFileSizeKb.value);
}